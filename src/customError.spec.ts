...
describe('customError', () => {
    ...
    test(`creates correct error when type is set to CreateCourseFromRequestMiddleware`, () => {
        expect.assertions(3);

        const customError = new CustomError(ErrorType.CreateCourseFromRequestMiddleware);
        const { code, message, httpStatusCode } = customError;
    ...
    test(`creates correct error when type is set to SendFormattedCourseMiddleware`, () => {
        expect.assertions(3);

        const customError = new CustomError(ErrorType.SendFormattedCourseMiddleware);
        const { code, message, httpStatusCode } = customError;
    ...
    test(`creates correct error when type is set to CreateSessionFromRequestMiddleware`, () => {
        expect.assertions(3);

        const customError = new CustomError(ErrorType.CreateSessionFromRequestMiddleware);
        const { code, message, httpStatusCode } = customError;
    ...
    test(`creates correct error when type is set to SendFormattedSessionMiddleware`, () => {
        expect.assertions(3);

        const customError = new CustomError(ErrorType.SendFormattedSessionMiddleware);
        const { code, message, httpStatusCode } = customError;
